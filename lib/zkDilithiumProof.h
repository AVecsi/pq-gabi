...
#define HASH_PHASE_CYCLES 2

#define NONCE_INSERT HASH_CYCLE_LEN

#define S_BALL_START (HASH_PHASE_CYCLES * HASH_CYCLE_LEN)
...
const uint8_t *prove_signature(const uint32_t *z_ptr,
                               ...
                               const uint32_t *salt_ptr,
                               const uint32_t *nonce_ptr,
                               const uint32_t *htr_ptr,
                               const uint32_t *t_ptr,
